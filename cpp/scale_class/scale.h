...
class Scale {
public:
    Scale(const std::pair<float, float>& scale_a,
          const std::pair<float, float>& scale_b)
            : scale_a_(scale_a),
              scale_b_(scale_b),
              a_scale_ratio_((scale_a.second - scale_a.first) /
                             (scale_b.second - scale_b.first)),
              b_scale_ratio_((scale_b.second - scale_b.first) /
                             (scale_a.second - scale_a.first)) {}
